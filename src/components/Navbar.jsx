...
const Navbar = () => {
	...
	return (
		<div className='navbar bg-base-100 border-b max-w-7xl mx-auto border-primary/50'>
			<div className='navbar-start'>
				<div className='dropdown'>
					<div
						tabIndex={0}
						role='button'
						className='btn btn-ghost text-primary pl-0 pr-1 lg:hidden'
					>
						<svg
					...
					>
						{links}
						<li className='mobile:hidden'>{themeSwitcher}</li>
					</ul>
				</div>
				<Link
					to='/'
					className='flex items-center font-extrabold italic text-primary mobile:text-xl'
				>
					<svg
						className='w-10 h-10'
						version='1.0'
			...
			<div className='navbar-end gap-2'>
				{/* Theme Switcher */}
				<div className="hidden mobile:block">{themeSwitcher}</div>
				{/* User Profile */}
				{user ? (
					<>
